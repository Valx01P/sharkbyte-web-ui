...
const Navbar = () => {
 ...
 return (
   <nav className="fixed top-0 z-10 w-full bg-gray-900 text-white pixel-shadow-2">
     <div className="flex">
       ...
       <div className='max-[1026px]:hidden flex items-center w-full px-4 max-[1350px]:px-2'>
         ...
         <ul className="flex justify-center items-center gap-6 w-full max-[1350px]:gap-4">
           <a href="/" className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm">Home</a>
           <a href="/about" className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm">About</a>
           <a href="/schedule" className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm">Schedule</a>
           <a href="/faq" className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm">FAQ</a>
           <a href="/sponsors" className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm">Sponsors</a>
         </ul>
       </div>
       ...
       <div className='max-[1026px]:hidden flex-auto'>
         <div className="flex items-center justify-end w-full">
           ...
           <div className='transition-transform duration-300 hover:scale-105'>
             <Link href="/login" className="bg-gradient-to-l from-[#6366f1] to-[#8b5cf6] text-white px-3 border-3 border-gray-600 pixel-shadow max-[1350px]:text-sm max-[1350px]:px-2">
               Login
             </Link>
           </div>
           {/* DIVIDER */}
             ...
             <div className={`fixed top-0 right-0 h-dvh w-full max-w-[350px] bg-gray-900 text-white z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
               ...
               <div className="flex flex-col items-end pr-8 space-y-6">
                 ...
                 <div className="flex flex-col items-end space-y-4">
                   <a href="/" className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Home</a>
                   <a href="/about" className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">About</a>
                   <a href="/schedule" className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Schedule</a>
                   <a href="/faq" className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">FAQ</a>
                   <a href="/sponsors" className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Sponsors</a>
                 </div>
                 
                 {/* Login button */}
                 <div className="pt-4 transition-transform duration-300 hover:scale-105">
                   <Link href="/login" className="bg-gradient-to-l from-[#6366f1] to-[#8b5cf6] text-white px-4 py-2 border-3 border-gray-600 pixel-shadow">
                     Login
                   </Link>
                 </div>
