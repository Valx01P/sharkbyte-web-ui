 ...
 return (
   <nav className="fixed top-0 z-10 h-[60px] w-full bg-gray-900 text-white pixel-shadow-2">
     <div className="flex justify-between h-full relative px-4 max-[1026px]:px-0">
      {
        (pathname === '/') &&
        <a href="https://mlh.io/na?utm_source=na-hackathon&utm_medium=TrustBadge&utm_campaign=2026-season&utm_content=white" className='w-[115px] h-[175px] max-[1350px]:w-[100px] max-[1350px]:h-[145px] fixed top-[60px] left-[10px]'>
          <Image
            src="/svgs/mlh.svg"
            alt="mlh-logo"
            width={200}
      ...
      <div className='max-[1026px]:hidden flex items-center justify-end relative'>
        <div className="flex items-center">
          ...
          <div className='flex gap-2 pr-2 max-[1350px]:text-sm'>
            ...
            <a href="https://linkedin.com/company/sharkbyte" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://instagram.com/sharkbytehack" target="_blank" rel="noopener noreferrer">
