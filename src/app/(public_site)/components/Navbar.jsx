      ...
      <div className="flex">
        ...
        <div className="max-[1026px]:hidden flex items-center w-full px-4 max-[1350px]:px-2">
          ...
          <ul className="flex justify-center items-center gap-6 w-full max-[1350px]:gap-4">
            <a
              href="/"
              className="flex justify-center items-center relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full max-[1350px]:text-sm"
            >
              Home
            </a>
            <a
        ...
        <div className="max-[1026px]:hidden flex-auto">
          <div className="flex items-center justify-end w-full">
            ...
            <div className="transition-transform duration-300 hover:scale-105">
              <Link
                href="/register"
                className="bg-white px-3 border-3 pixel-shadow max-[1350px]:text-sm max-[1350px]:px-2"
              >
                Register
              </Link>
            </div>
        ...
        <div className="min-[1026px]:hidden flex w-full">
          ...
          {isMobileMenuOpen && (
            <>
              ...
              {/* Sidebar menu */}
              <div
                className={`fixed top-0 right-0 h-dvh w-full max-w-[350px] bg-white z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
              >
                {/* Close button */}
                ...
                <div className="flex flex-col items-end pr-8 space-y-6">
                  ...
                  <div className="flex flex-col items-end space-y-4">
                    <a
                      href="/"
                      className="text-right relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full"
                    >
                      Home
                    </a>
                    <a
