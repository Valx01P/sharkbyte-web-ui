   ...
   <section id='socials' className="w-screen h-screen flex flex-col justify-center items-center relative overflow-hidden pixel-bg-socials p-4">
     ...
     <div className="flex flex-col items-center">
       ...
       <div className="flex gap-6 mb-12 max-[650px]:gap-4 max-[650px]:mb-8">
         ...
         <a href="https://www.linkedin.com/company/init-mdc-north/" target="_blank" rel="noopener noreferrer" className="bg-gray-900 p-4 border-3 border-gray-600 pixel-shadow transition-transform duration-300 hover:scale-110 cursor-pointer max-[650px]:p-3">
         ...
         <a href="https://www.instagram.com/init.mdcnorth/" target="_blank" rel="noopener noreferrer" className="bg-gray-900 p-4 border-3 border-gray-600 pixel-shadow transition-transform duration-300 hover:scale-110 cursor-pointer max-[650px]:p-3">
      ...
      <Link
        ...
        className="group"
      >
        <h1 className="relative w-min overflow-hidden bg-gradient-to-l from-[#6366f1] to-[#8b5cf6] px-6 py-3 border-3 border-gray-600 pixel-shadow text-white max-[650px]:px-4 max-[650px]:py-2">
          <span className="relative z-20 block font-bold text-base max-[1350px]:text-base max-[650px]:text-sm">
            Register
          </span>
